...
<form name = "frmSelect" action="EditFault.jsp" method="get">
<body>
...
while (iterator.hasNext()){
	...
	%>
	<input type = "radio" name="select" value=<%=md.getFaultid()%><a href="FaultSum?faultId=<%=md.getFaultid() %>" ><%=md.getFaultSummary() %></a>><br/><%
}
}
%>
