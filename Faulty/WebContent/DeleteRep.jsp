...
while (iterator.hasNext()){
	...
	%>
	<input type ="radio" name="delR" value=<%=md.getAuthorid() %> <a href="ListReporters?idauthor=<%=md.getAuthorid() %>" >Name: <%=md.getForename()%> <%=md.getSurname()%>     Role:<%=md.getPrivilege() %>    Fault ID:<%=md.getFid()%></a>/><br/><%		
}
}
%>
